...
class Main:
    def __init__(self):
        ...
        self.thingsToSend = ["self.speed", "self.turn", "self.autoTrue", "self.intake", "self.arm", "self.extend"]
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                # you've finished this to figure out how to use the data you've sent.
                    ...
                    elif (event.key == pygame.K_1 and self.autoTrue == 1):
                        self.autoTrue = 0
                        self.input_dirty = True
                    elif (event.key == pygame.K_i and self.intake == 1) or (event.key == pygame.K_k and self.intake == -1):
                        self.intake = 0
                        self.input_dirty = True
                    elif (event.key == pygame.K_n and self.arm == 1) or (event.key == pygame.K_m and self.arm == -1):
                        self.arm = 0
                        self.input_dirty = True
                    elif (event.key == pygame.K_j and self.arm == 1) or (event.key == pygame.K_l and self.arm == -1):
                        self.extend = 0
                        self.input_dirty = True
